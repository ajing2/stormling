define("pages/editor/editor_for_web1.js",["3rd/editor/editor.js","pages/modules/media_dialog/question_dialog/questionDialog4Web1.js","pages/modules/media_dialog/link_dialog/linkDialog4Web1.js","pages/editor/audioMusicDialog4Web1.js","pages/editor/videoDialog4Web1.js","pages/editor/weappDialog4Web1.js","pages/editor/videoAdBackPanelDialog4web1.js","pages/editor/videoAdBackPanelDialog4web1copy.js","pages/editor/videoTransitionDialog4web1.js","pages/editor/cpsDialog4Web1.js","pages/editor/blockquoteDialog4Web1.js","pages/modules/media_dialog/image_dialog/imageDialog4Web1.js","pages/editor/ad_insert_statement_dialog.js","pages/editor/templateDialog4Web1.js","pages/modules/media_dialog/music_check_dialog/musicCheckDialog4Web1.js","pages/modules/media_dialog/pay_statement_dialog/payStatementDialog4Web1.js","pages/editor/albumChooseDialog4Web1.js","pages/modules/media_dialog/darkmode_notice_dialog/darkmodeNoticeDialog4Web1.js","pages/editor/eventBus4Web1.js","pages/editor/editor_store.js","vat/vat.js","pages/modules/media_dialog/red_package_cover_dialog/redPackageCoverDialog4Web1.js","js/common/qq/events.js","vue-weui/src/gallery/gallery.js","pages/modules/media_dialog/mass_send_dialog/mass_send_dialog.js","pages/reward/modules/auto_apply_list/auto_apply_list.js"],function(e,a,s){"use strict"
e("3rd/editor/editor.js")
var o=e("pages/modules/media_dialog/question_dialog/questionDialog4Web1.js"),i=e("pages/modules/media_dialog/link_dialog/linkDialog4Web1.js"),t=e("pages/editor/audioMusicDialog4Web1.js"),l=e("pages/editor/videoDialog4Web1.js"),d=e("pages/editor/weappDialog4Web1.js"),g=e("pages/editor/videoAdBackPanelDialog4web1.js"),n=e("pages/editor/videoAdBackPanelDialog4web1copy.js"),r=e("pages/editor/videoTransitionDialog4web1.js"),c=e("pages/editor/cpsDialog4Web1.js"),u=e("pages/editor/blockquoteDialog4Web1.js"),m=e("pages/modules/media_dialog/image_dialog/imageDialog4Web1.js"),p=e("pages/editor/ad_insert_statement_dialog.js"),v=e("pages/editor/templateDialog4Web1.js"),D=e("pages/modules/media_dialog/music_check_dialog/musicCheckDialog4Web1.js"),b=e("pages/modules/media_dialog/pay_statement_dialog/payStatementDialog4Web1.js"),_=e("pages/editor/albumChooseDialog4Web1.js"),j=e("pages/modules/media_dialog/darkmode_notice_dialog/darkmodeNoticeDialog4Web1.js"),k=e("pages/editor/eventBus4Web1.js"),B=e("pages/editor/editor_store.js"),h=e("vat/vat.js"),W=e("pages/modules/media_dialog/red_package_cover_dialog/redPackageCoverDialog4Web1.js"),f=e("js/common/qq/events.js")(!0)
e("vue-weui/src/gallery/gallery.js"),e("pages/modules/media_dialog/mass_send_dialog/mass_send_dialog.js"),e("pages/reward/modules/auto_apply_list/auto_apply_list.js")
var P={redPackageCoverDialog:W,payStatementDialog:b,albumChooseDialog:_,darkmodeNoticeDialog:j},y=h.init({el:"#vue_app",store:B,data:function(){var e={audioMusicDialog:t.getParams(),videoDialog:l.getParams(),weappDialog:d.getParams(),cpsDialog:c.getParams(),blockquoteDialog:u.getParams(),adInsertStatementDialog:p.getParams(),videoAdBackPanelDialog:g.getParams(),videoAdBackTransitionDialog:r.getParams(),imageDialog:m.getParams(),linkDialog:i.getParams(),imageUrls:[],showGallery:!1,showSendDailog:!1,sendData:{},gallerySelected:0,templateDialog:v.getParams(),musicCheckDialog:D.getParams(),darkmodeNoticeDialog:j.getParams()}
for(var a in P){if(Object.prototype.hasOwnProperty.call(P,a))e[a.substr(0,1).toLocaleLowerCase()+a.substr(1)]=P[a].getParams()}return e},mounted:function(){var a=this
for(var e in t.bindEvent({eventBus:k,params:this.audioMusicDialog}),l.bindEvent({eventBus:k,params:this.videoDialog}),g.bindEvent({eventBus:k,params:this.videoAdBackPanelDialog}),r.bindEvent({eventBus:k,params:this.videoAdBackTransitionDialog}),d.bindEvent({eventBus:k,params:this.weappDialog}),c.bindEvent({eventBus:k,params:this.cpsDialog}),n.bindEvent({eventBus:k,params:this.legalCheckDialog}),u.bindEvent({eventBus:k,params:this.blockquoteDialog}),o.bindEvent({eventBus:k,$store:this.$store}),m.bindEvent({eventBus:k,$store:this.$store,params:this.imageDialog}),p.bindEvent({eventBus:k,$store:this.$store,params:this.adInsertStatementDialog}),i.bindEvent({eventBus:k,params:this.linkDialog}),v.bindEvent({eventBus:k,params:this.templateDialog}),D.bindEvent({eventBus:k,params:this.musicCheckDialog}),f.on("img9DataChanged",function(e){a.imageUrls=e}),f.on("img9DataSelected",function(e){a.gallerySelected=e,a.showGallery=!0}),P)if(Object.prototype.hasOwnProperty.call(P,e)){var s=e.substr(0,1).toLocaleLowerCase()+e.substr(1)
P[e].bindEvent({eventBus:k,params:this[s]})}},methods:function(){var s={selectAudio:function(e){t.close({eventBus:k,data:e})},selectVideo:function(e,a,s){l.close({eventBus:k,data:e,tab:a,scene:s})},closeVideoAdBack:function(e){g.close({eventBus:k,data:e})},closeVideoAdTransition:function(e){r.close({eventBus:k,data:e})},closeLegalCheck:function(e){n.close({eventBus:k,data:e})},selectWeapp:function(e){d.close({eventBus:k,data:e})},selectCps:function(e){c.close({eventBus:k,data:e})},selectBlockquote:function(e){u.close({eventBus:k,data:e})},selectQuestion:function(e){o.close({eventBus:k,data:e})},selectImage:function(e){m.close({eventBus:k,data:e})},closeAdInsertStatementDialog:function(){p.close({params:this.adInsertStatementDialog})},selectLink:function(e){i.close({eventBus:k,data:e})},selectTemplate:function(e){v.close({eventBus:k,data:e})},closeMusicCheck:function(e){D.close({eventBus:k,data:e})}}
for(var e in P)Object.prototype.hasOwnProperty.call(P,e)&&function(a){var e=a.substr(0,1).toUpperCase()+a.substr(1)
s["close"+e]=function(e){P[a].close({eventBus:k,data:e})}}(e)
return s}()})
s.exports=y})
"use strict"
...
var n=+new Date
this.__g.remoteImgInstance=new h({mpeditor:this,catchTipsDom:this.__o.catchTipsDom})
var o=+new Date
...
if(8===i||46===i||13===i){var h=this.selection.getRange()
if(h.collapsed&&h.startContainer){y=null,u=v=m=!1
var g=function(e){return b.findParent(e,function(e){return!!b.isBlockElm(e)},!1)}
if(13===i){var n=h.createBookmark(),o=g(n.start)
return o&&o.getAttribute("class")&&(u=!0),void h.moveToBookmark(n).select(!0)}var _=function(e,t){if(e&&3===e.nodeType){var i="",n=""
...
var a=h.createBookmark()
"pre"===r&&b.isUneditablePluginNode({node:a.start.nextSibling})&&(y=a.start.ownerDocument.createElement("span"),a.start.parentNode.insertBefore(y,a.start.nextSibling),v=!0),function(e,t,i){for(var n=null,o=g(e),r=function(e){return 2===b.isContentEditable({node:e,checkParent:!1})};n=b.getDelNode({node:e,filter:r,type:t});){var a=!1,s=null
if((n.parentNode===e.parentNode||(s=g(n))&&s===o)&&(a=!0),a&&3===n.nodeType){if(_(n,t),n.nodeValue)break}else if(b.isMarkNode(n)&&n.parentNode)n.parentNode.removeChild(n)
...
break}if("br"!==n.nodeName.toLowerCase()){!a&&y&&(s=s||g(n))&&b.isEmptyNode(s,!1)&&s.parentNode.removeChild(s)
break}var u=!1
...
var f=!1
p||(f=!0,p=b.createFillcharTextNode(i.start.ownerDocument),i.start.parentNode.insertBefore(p,i.start),v=!0),h.moveToBookmark(i),f&&("pre"===t?h.selectNode(p).collapse(!0):"next"===t&&h.selectNode(p).collapse(!1)),h.select(!0)}(a.start,r,a)}}})}l.addListener("afterscencerestore cleardoc",function(e){p.handleEvent({editor:l})}),l.addListener("dbcache_get",function(e){var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{}
...
for(var a=0,s=r.length;a<s;a++)void 0===e[r[a]]&&(e[r[a]]="")}}return e},getEditorData:function(e,t){var i=null;(i=l.filterBr({node:this.getUeditor().body})).hasFilterNode&&this.fireEvent("reportAddNum",67292,121,1),this.fireEvent("beforeGetEditorData",this.getUeditor().body.innerHTML,[this.getUeditor().body])
for(var n=this.__o.plugins,o=0,r=n.length;o<r;o++){"function"==typeof(s=n[o]).beforeGetContent&&s.beforeGetContent()}(e=e||{}).content=this.ueditor.getContent(void 0,function(){return!0},void 0,void 0,void 0,t),(i=l.filterBr({html:e.content})).hasFilterHtml&&(e.content=i.html,this.fireEvent("reportAddNum",67292,122,1))
var a=[]
for(o=0,r=n.length;o<r;o++){var s
if("function"==typeof(s=n[o]).getPluginData){var d=this.getPluginDataTmpl(e)
s.getPluginData({init:d.init}),this.fillPluginData(d,e)}"function"==typeof s.getfilterIdTagNameWhiteList&&(a=a.concat(s.getfilterIdTagNameWhiteList()))}return a=","+a.join(",")+",",e.content=e.content.replace(/(<\w+[^>]*)\sid=\"([^\">]*)\"([^>]*>)/g,function(e,t,i,n){var o=e.split(" ")[0].replace("<","")
return a&&0<=a.indexOf(","+o+",")?e:t+n}),e.content=e.content.replace(/(<[^>]+?style=([\'\"]))([^\2]*?text-decoration-line[\s]*:[^\2]*?)(\2)/gi,function(){return arguments[1]+arguments[3].replace(/text-decoration-line[\s]*:/g,"text-decoration:")+arguments[4]}),e.content=e.content.replace(/(<[^>]+?style=([\'\"]))([^\2>]*?-ms-overflow[^\2>]+?)(\2)/gi,function(){return arguments[1]+arguments[3].replace(/-ms-overflow/g,"overflow")+arguments[4]}),e.content=l.formatStyle(e.content),e.content=l.formatRedundancyStr(e.content),this.__g.classWhiteListRules&&this.__g.classWhiteListRules.whiteList&&(e.content=l.formatClass(this.__g.classWhiteListRules,e.content)),this.formatCheckTextInfo({data:e}),e},setClassWhiteListRules:function(e){for(var t="rich_pages,blockquote_info,blockquote_biz,blockquote_other,blockquote_article,js_jump_icon,h5_image_link,js_banner_container,js_list_container,js_cover,js_tx_video_container,js_product_err_container,js_product_loop_content,js_product_container,img_loading,list-paddingleft-1,list-paddingleft-2,list-paddingleft-3,selectTdClass,noBorderTable,ue-table-interlace-color-single,ue-table-interlace-color-double,__bg_gif,weapp_text_link,weapp_image_link,js_img_loading,wx_video_context,db,wx_video_thumb_primary,wx_video_play_btn,wx_video_mask".split(","),i=[new RegExp("^editor__content__"),new RegExp("^js_"),new RegExp("^cps_inner"),new RegExp("^bizsvr_"),new RegExp("^code-snippet"),new RegExp("^qa__"),new RegExp("^wx-edui-")],n=/^(\.[:-\w\d\s,\.]+)\{*|[\b\n\}]+(\.[:-\w\d\s,\.]+)\{*/g,o=null;e&&null!==(o=n.exec(e));)try{this.getIframeClass(o,t)}catch(e){console.error(e)}var r=[p.pluginParentClass,p.parentClass,p.selectedClass]
...
return!this.__o.needCheckText||!i||!1===this.fireEvent("is_article_data_inited")?i:(t.content_checktext=i,t.content=o.clearSplitTag(i),void o.setCacheData({content:"",checkTextInfo:t.check_text_info,appmsgId:this.__o.app_id,seq:t.seq}))},fillPluginData:function(e,t){var i=e.getData()
...
break}}}},n.__editorIframeMouseup=function(e){if(e&&e.parent&&e.parent.window){var t=N(e.parent.window)
...
c(n)}("next")})}}define("3rd/editor/plugin/checkTextUtils.js",["pages/modules/utils/str_util.js","3rd/store/store.js","pages/modules/dbCache/dbCache.js","pages/modules/utils/cgi.js","3rd/editor/common/domUtils.js"],function(e,t,a){var h=this,n=e("pages/modules/utils/str_util.js"),d=e("3rd/store/store.js"),g=e("pages/modules/dbCache/dbCache.js"),i=e("pages/modules/utils/cgi.js"),c=e("3rd/editor/common/domUtils.js"),l={checkResult:{},cacheKey:"mpchecktextinfo",cacheValidTime:2592e6,checkQueue:[],checktexting:!1,splitChar:[{value:"？",escape:!1},{value:"！",escape:!1},{value:"。",escape:!1},{value:"：",escape:!1},{value:"；",escape:!1}],blockTag:{p:1,section:1,br:1,iframe:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1,hr:1,table:1,ul:1,div:1,dl:1,ol:1,pre:1,form:1,figure:1,output:1,hgroup:1,video:1,footer:1,header:1,canvas:1,audio:1,aside:1,figcaption:1,address:1,blockquote:1,center:1,dir:1,fieldset:1,isindex:1,menu:1,noframes:1},splitTagName:c.checktextTagName,splitTagText:"mpchecktext@#%mpchecktext",tmpTagName:c.checktextTmpTagName,highlineClass:"character selected",highlineclassJs:"js_checktext",highlineTagName:"span",uid:+new Date}
function r(){return l.uid+++"_"+Math.random()}function u(e){e=e||{}
return p({tagName:l.splitTagName,needGlobal:e.needGlobal})}function p(e){return e.needGlobal?new RegExp("<"+e.tagName+"[^<>]*>[^<>]*</"+e.tagName+">","g"):new RegExp("<"+e.tagName+"[^<>]*>[^<>]*</"+e.tagName+">")}function o(){if(!0!==l.checktexting&&0!=l.checkQueue.length){var e=l.checkQueue.shift()
e.data&&("1"==e.data.status?function(a){if(!(a&&a.data&&a.data.origin&&a.instance))return
if(!0===s(a))return o()
if(l.checktexting)return
l.checktexting=!0,a.data.status=2,i.post({url:"/cgi-bin/spellingcheck?",dataType:"json",data:{action:"check",content:a.data.origin}},function(e){if(e&&e.base_resp&&0==+e.base_resp.ret){var t=[]
e.check_result&&e.check_result.check_item&&e.check_result.check_item.position&&0<e.check_result.check_item.position.length&&(t=e.check_result.check_item.position),m({origin:a.data.origin,position:t}),s(a)}else a.data.status=5
l.checktexting=!1,o()},function(){l.checktexting=!1,a.data.status=5,o()})}(e):o())}}function s(e){if(!(e&&e.data&&e.data.origin&&e.instance))return!1
var t=encodeURIComponent(e.data.origin||"")
if(l.checkResult[t]){var a=l.checkResult[t]
if(a.position&&0<a.position.length){var i=e.instance.getCheckTextInfo()
i&&i[e.data.id]===e.data&&e.instance.getTextByEndSplit(e.data.id)===e.data.origin?(e.data.status=3,e.data.position=a.position,f(e)):e.instance.clearSplitElement({id:e.data.id})}else e.data.status=4,e.data.position=[],f(e)
return!0}return!0===e.data.noRequest?(m({origin:e.data.origin,position:[]}),e.data.status=4,e.data.position=[],f(e),!0):e.data.origin!==n.text(e.data.origin)&&(m({origin:e.data.origin,position:[]}),e.data.status=4,e.data.position=[],f(e),function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{}
if(!e.instance||!e.instance.editor)return
if(1===parseInt(10*Math.random(),10)){var t=e.instance.editor.getDocument().body.innerHTML
e.instance.editor.fireEvent("mplog",{level:"info",description:"checktext has html tag",data:{text:e.text,body:t}}),window.WX_BJ_REPORT&&window.WX_BJ_REPORT.BadJs&&window.WX_BJ_REPORT.BadJs.report&&window.WX_BJ_REPORT.BadJs.report("checktext has html tag","https://mp.weixin.qq.com/cgi-bin/appmsg?t=media/appmsg_edit&action=edit",{mid:"mmbizweb2:monitorChecktextHasHtmlTag"})}e.instance.editor.fireEvent("reportAddNum","122443","5",1)}({text:e.data.origin,instance:e.instance}),!0)}function m(e){if(e&&e.origin&&e.position){var t=encodeURIComponent(e.origin||"")
l.checkResult[t]={origin:e.origin,position:e.position}}}function f(e){setTimeout(function(){e.instance.updateErrCount({afterCheck:!0,status:e.data.status,splitId:e.data.id})},0)}!function(){for(var e=[],t=0,a=l.splitChar.length;t<a;t++)e.push(l.splitChar[t].value)
l.splitcharStr=e.join("")}()
function T(e,t){return l.cacheKey+"_"+wx.data.uin+"_"+e+"_"+t}function k(){return(new Date).getTime()+l.cacheValidTime}var x,v=(x=_asyncToGenerator(regeneratorRuntime.mark(function e(t,a){var i,n,c,r,o,s,l,u
return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return i=void 0,e.prev=1,n=T(t,a),e.next=5,g.get({cacheKey:n})
case 5:if((!(i=e.sent)||!i.cacheValue)&&(c=d.get(n))&&c.checkTextInfo){r=null
try{r=JSON.parse(c.checkTextInfo)}catch(e){r=null}r&&(i={cacheValue:{content:"",checkTextInfo:r},cacheKey:n,updateTime:(new Date).getTime(),expireTime:k()})}if(i&&i.cacheValue&&(o=i.cacheValue)&&o.checkTextInfo)for(l in s=o.checkTextInfo)(u=s[l])&&u.origin&&"[object Array]"===Object.prototype.toString.call(u.position)&&("3"==u.status||"4"==u.status)&&m({origin:u.origin,position:u.position})
e.next=13
break
...
return{splitcharStr:l.splitcharStr,splitChar:l.splitChar,splitTagName:l.splitTagName,getSplitTag:function(e){return e=e||r(),"<"+l.splitTagName+' contenteditable="false" id="'+e+'"></'+l.splitTagName+">"},getSplitTagReg:u,tmpTagName:l.tmpTagName,getUid:r,splitTagText:l.splitTagText,blockTag:l.blockTag,clearSplitTag:function(e){if(!e)return""
var t,a,i=(t={needGlobal:!0},a="<"+l.highlineTagName+"[^>]*"+l.highlineclassJs+"[^<>]*>([^<>]*)</"+l.highlineTagName+">",t.needGlobal?new RegExp(a,"g"):new RegExp(a))
if(e=e.replace(u({needGlobal:!0}),"").replace(p({needGlobal:!0,tagName:l.tmpTagName}),"").replace(i,"$1"),new RegExp("<"+l.highlineTagName+"[^>]*"+l.highlineclassJs+"[^<>]*>").test(e)){var n=document.createElement("div")
n.innerHTML=e
var c=n.querySelectorAll(l.highlineTagName+"."+l.highlineclassJs)
if(c&&0<c.length){for(var r=0,o=c.length;r<o;r++){for(var s=c[r];s.firstChild;)s.parentElement.insertBefore(s.firstChild,s)
s.parentElement.removeChild(s)}e=n.innerHTML}}return e},addCheckInfoQueue:function(e){l.checkQueue.push(e),o()},clearQueue:function(){l.checkQueue=[]},setCacheData:function(e){e.appmsgId&&g.set({data:{cacheKey:T(e.appmsgId,e.seq),cacheValue:{content:e.content||"",checkTextInfo:e.checkTextInfo},expireTime:k()}})},getCacheData:v,removeCacheData:function(e,t){g.remove({cacheKey:T(e,t)})},highlineClass:l.highlineClass,highlineclassJs:l.highlineclassJs,highlineTagName:l.highlineTagName,isDbCacheSupported:g.isSupported,html:function(e,t){var a=void 0
a=!1===t?["&#39;","'","&quot;",'"',"&#32;"," ","&#160;"," ","&nbsp;"," ","&gt;",">","&lt;","<","&amp;","&"]:["&","&amp;","<","&lt;",">","&gt;"," ","&#32;"," ","&nbsp;",'"',"&quot;","'","&#39;"]
...
define("pages/modules/utils/cgi.js",["pages/modules/utils/ajax.js","pages/modules/utils/str_util.js","pages/modules/utils/object.js","pages/modules/utils/url.js"],function(e,t,a){"use strict"
function o(e){for(var t=e||{},a=Object.keys(m),r=0;r<a.length;r++)t[a[r]]=m[a[r]]
return t}function n(e,t){var a=-1!==location.href.indexOf("/cgi-bin/home")&&(-1!==t.url.indexOf("/misc/safeassistant")||-1!==t.url.indexOf("/safe/safeuuid")),r=11
switch(e){case"timeout":r=7
break
case"error":r=8
break
case"notmodified":r=9
break
case"parsererror":r=10
break
default:r=11}for(var o=["lang","random","f","ajax","token"],n=0;n<o.length;++n){var s=o[n]
t.data&&t.data[s]&&delete t.data[s]}r+=a?100:0,u({url:"/misc/jslog?1=1",data:{content:d.format("[fakeid={uin}] [xhr] [url={url}] [param={param}] [info={info}] [useragent={useragent}] [page={page}]",{uin:window.wx.commonData.data.uin,useragent:window.navigator.userAgent,page:location.href,url:t.url,param:JSON.stringify(t.data).substr(0,50),info:e}),id:r,level:"error"},type:"POST"}),u({url:"/misc/jslog?1=1",data:{content:d.format("[fakeid={uin}] [xhr] [url={url}] [param={param}] [info={info}] [useragent={useragent}] [page={page}]",{uin:window.wx.commonData.data.uin,useragent:window.navigator.userAgent,page:location.href,url:t.url,param:JSON.stringify(t.data).substr(0,50),info:e}),id:6+(a?100:0),level:"error"},type:"POST"}),"timeout"===e&&Vue.prototype.$tipsErr("你的网络环境较差，请稍后重试")}function s(e,n){var s=e
return"function"!=typeof s&&(s=function(){}),e=function(e){try{var t=s.toString(),a={uin:wx.commonData.data.uin||"0",id:"64430",key:"0",url:"",location:encodeURIComponent(window.location.href)||"",ret:e&&e.base_resp&&e.base_resp.ret||"undefined"}
if(e&&e.base_resp&&0!==e.base_resp.ret&&(t.indexOf("handleRet")<0&&t.indexOf(e.base_resp.ret)<0&&((new Image).src=d.format("https://badjs.weixinbridge.com/badjs?level=4&uin={uin}&id={id}&msg={msg}&from={url}",{uin:a.uin,url:a.url||a.location,id:138,msg:encodeURIComponent("ret="+a.ret+"|idkey="+a.id+":"+a.key)})),void 0!==window.WX_BJ_REPORT&&window.WX_BJ_REPORT.BadJs)){var r=""
if(-1!==n.indexOf("?")){r=n.substr(0,n.indexOf("?"))
var o=l.parseQuery(n)
o.action&&(r+="?action="+o.action)}else r=n
window.WX_BJ_REPORT.BadJs.report(r,"ret="+e.base_resp.ret,{mid:window.PAGE_MID,view:"web_retcode"})}}catch(e){console.error(e)}s(e)}}var i=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t]
for(var r in a)Object.prototype.hasOwnProperty.call(a,r)&&(e[r]=a[r])}return e},u=e("pages/modules/utils/ajax.js"),d=e("pages/modules/utils/str_util.js"),c=e("pages/modules/utils/object.js"),l=e("pages/modules/utils/url.js"),m={token:window.wx.commonData.data.t,lang:window.wx.commonData.data.lang,f:"json",ajax:"1"},p={0:"恭喜你，操作成功！","-1":"系统错误，请稍后尝试。",200002:"参数错误，请核对参数后重试。",200003:"登录超时，请重新登录。",200004:"请求页面的域名没有授权。",200005:"请求方式错误，请确认请求方式后重试。",200006:"表单名称验证出错，请核对表单名称后重试。",200007:"对不起，你没有权限访问目标请求。",200040:"登录超时，请重新登录。"},r={updateCommonPostData:function(){m={token:window.wx.commonData.data.t,lang:window.wx.commonData.data.lang,f:"json",ajax:"1"}},get:function(a,e,r,t){a.data=o(a.data),a.success=a.success||e,a.complete=a.complete||t,r=a.error||r,a.error=function(e,t){n(t,a),r&&r(e,t)},a.dataType="json",a.success=s(a.success,a.url),u(a)},post:function(a,e,r,t){a.type="POST",a.data=o(a.data),a.success=a.success||e,a.complete=a.complete||t,r=a.error||r,a.error=function(e,t){n(t,a),r&&r(e,t)},a.dataType="json",a.success=s(a.success,a.url),u(a)},handleRet:function(e,t){console.log(e,t)
var a={msg:t.msg||"系统繁忙，请稍后尝试"}
if(e&&e.base_resp&&e.base_resp.ret){t=c.clone(t,!0),(t=i({uin:wx.commonData.data.uin||"0",id:"64430",key:"0",url:"",location:encodeURIComponent(window.location.href)||"",ret:e.base_resp.ret,showMsg:!0,msg:"系统繁忙，请稍后尝试"},t)).url=encodeURIComponent(t.url)
var r=p[t.ret]
r?(t.showMsg&&Vue.prototype.$tipsErr(r),a.msg=r):((new Image).src=d.format("/mp/unknow_ret_report?uin={uin}&id={id}&key={key}&url={url}&location={location}&ret={ret}&method=get&action=report",t),t.showMsg&&Vue.prototype.$tipsErr(t.msg),(new Image).src=d.format("/mp/unknow_ret_report?uin={uin}&id=64430&key=126&url={url}&location={location}&ret={ret}&method=get&action=report",t),(new Image).src=d.format("https://badjs.weixinbridge.com/badjs?level=4&uin={uin}&id={id}&msg={msg}&from={url}",{uin:t.uin,url:t.url||t.location,id:138,msg:encodeURIComponent("ret="+t.ret+"|idkey="+t.id+":"+t.key)}))}return a}}
a.exports=r})
...
"use strict"
define("3rd/editor/plugin/filter.js",[],function(e,t,r){return{filterBr:function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},t={html:e.html,hasFilterHtml:!1,node:e.node,hasFilterNode:!1}
if(e.html&&/(<br[^<>]*>\s*<br[^<>]*>){10,}/.test(e.html)&&(t.hasFilterHtml=!0,t.html=e.html.replace(/(<br[^<>]*>\s*<br[^<>]*>){10,}/g,"$1")),e.node&&e.node.getElementsByTagName)for(var r=e.node.getElementsByTagName("svg"),a=0,n=r.length;a<n;a++)for(var l=r[a].getElementsByTagName("br"),i=0;i<l.length;i++){var s=l[i]
s.parentNode.removeChild(s),t.hasFilterNode=!0,i--}return t},formatRedundancyStr:function(e){for(var t=["noscript","iframe"],r=0;r<t.length;r++){var a="(<#targetName#\\s*[^<>]*?>)[^<\\/]+?<\\/#targetName#>".replace(/#targetName#/g,t[r]),n="$1</#targetName#>".replace(/#targetName#/g,t[r]),l=new RegExp(a,"g")
e=e.replace(l,n)}return e},formatStyle:function(e){var t=new RegExp("(<[^<>]*?)\\sstyle=(?:(?:\"([^\"]*?)\")|(?:'([^']*?)')|([^'\"\\s=<>]*?))([\\s\\/>])","g")
return e=e.replace(t,function(e,t,r,a,n,l){var i=r||a||n||""
if(i){for(var s=[],g=0,o=(i=(i=i.replace(/&quot;/g,'"')).split(";")).length;g<o;g++){var f=i[g].replace(/^\s+/,"").replace(/\s+$/,"").replace(/"/g,"&quot;")
f&&s.push(f)}return t+' style="'+s.join(";")+';"'+l||""}return e})},filterStyleAttr:function(e,t){if(t){var r=(e=$(e)).attr("style")
if(r){"[object String]"==Object.prototype.toString.call(t)&&(t=[t])
for(var a=0,n=t.length;a<n;a++){var l=new RegExp("(^|;|\\b)[^;]*#attr#\\s*:[^;]*[$;]".replace("#attr#",t[a]),"g")
r=r.replace(l,"$1")}e.attr("style",r)}}},formatClass:function(e,t){var h=e.whiteList,v=e.whiteListReg,m=e.blackList
if(!h&&!v&&!m)return t
var r=new RegExp("(<[^<>]*?)\\sclass=(?:(?:\"([^\"]*?)\")|(?:'([^']*?)')|([^'\"\\s=<>]*?))([\\s\\/>])","g")
return t.replace(r,function(e,t,r,a,n,l){for(var i=(r||a||n||"").split(" "),s=[],g="",o=0,f=i.length;o<f;o++)if(g=i[o]){if(m&&~m.indexOf(g))continue
if(h&&~h.indexOf(g))s.push(g)
else if(v&&0<v.length)for(var c=0,u=v.length;c<u;c++)if(v[c].test(g)){s.push(g)
break}}var p=s.join(" ").trim()
return p?t+' class="'+p+'"'+l||"":t+l||""})},removeAttribute:function(e,t){for(var r="(<#tagName#[^<>]*?)\\s#attribute#=(?:(?:\"([^\"]*?)\")|(?:'([^']*?)')|([^'\"\\s=<>]*?))([\\s\\/>])",a=0,n=t.length;a<n;a++){var l=t[a],i=l[0],s=l[1],g=""
g=r.replace("#tagName#","*"===i?"":i)
for(var o=new RegExp(g.replace("#attribute#",s),"g");o.test(e);)e=e.replace(o,"$1$5")}return e},filterClass:function(e,l){if(!l||!e)return e
for(var t=l.split(" "),r="",a=0,n=t.length;a<n;a++)r&&(r+="|"),r+="(?:"+t[a]+")"
var i=new RegExp('(<[^<>]*?)\\sclass=((?:"[^"]*'+r+"[^\"]*\")|(?:'[^']*"+r+"[^']*'))","g")
return e.replace(i,function(){for(var e=arguments[2].replace(/['"]/g,"").split(" "),t=[],r=0,a=e.length;r<a;r++){var n=e[r]
n&&-1===(" "+l+" ").indexOf(" "+n+" ")&&t.push(n)}return arguments[1]+' class="'+t.join(" ")+'"'})}}})
