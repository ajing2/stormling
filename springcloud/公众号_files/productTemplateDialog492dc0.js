...
var o=l(a.templateId);
if(o){
var i=[];
for(r=[].concat(a.productData);r.length>0;)i.push(r.splice(0,o.loop));
for(var p=0,c=i.length;c>p;p++){
var n="";
n=b.smartTipsCompile({
smart_num:a.smartNum
}),e+=n,e+=m(i[p],a.templateId,a.color);
}
}
...
var o=b.templateData.template_list[e];
o.name||(o.name="模版"+(e+1)),o.color=b.defaultColor,o.pic_cover_url=o.pic_cover_url||"",
0==o.pic_cover_url.indexOf("http")||a||(o.pic_cover_url="https://res.wx.qq.com"+o.pic_cover_url);
}
...
0!=o.length&&0!=t.length&&(o+="/"),o+=t;
}),t.cps_desc=o,t.cps_desc_long="作者："+o;
}
}
function n(t){
...
var a=t.dataValue,r=a.appid+"_"+a.productId[0],o=e[r];
...
i.className=this.className,i.style.background='url("'+this.src+'") no-repeat center',
o.insertBefore(i,this),o.removeChild(this);
}
}
setTimeout(function(){
var r=a.ownerDocument,o=r?r.defaultView||r.parentWindow:null;
if(o&&t&&t.contentWindow===o){
var i=$(a).outerHeight()+24;
if($(t).css({
height:i+"px"
}),"undefined"!=typeof e){
...
var o=l(r);
if(!o)return"";
for(var i=o.template_xml,d=Math.min(o.loop,t.length),p={
url:"url",
title:"title",
desc:"cps_desc_long",
...
m="undefined"!=typeof n[p[s]]?n[p[s]]:p[s],i=i.replace(u,m);
}
}
var f=$("<div>").html(i),_=1;
...
var o=g(t.productData[e]);
a.push(o);
}
var i=r();
return b.iframeProductData[i]={
type:t.type,
productData:a,
...
appid:t.appid,
report:t.report
},b.copyIframeProductData[i]=b.iframeProductData[i],i;
}
function _(t){
...
var o=e[r];
"productData"==r?t.setAttribute("data-product",""):"productId"==r?t.setAttribute("data-pid",encodeURIComponent(o.join(b.pidSplitKey))):t.setAttribute("data-"+r.toLowerCase(),o);
}
}
}
function g(t){
