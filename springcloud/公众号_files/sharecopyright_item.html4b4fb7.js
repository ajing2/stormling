...
callback:function(e){
var t=e.currentPage;
t!=a&&(t--,n.begin=i*t,N.key&&(n.key=N.key),o(n));
}
});
}
}
function t(e,i,t,n,a,d,c){
...
var e=this;
if(1==r)return!0;
var i=l(g).parent().data("opt");
if(!i)return void _.err("请选择素材");
if(i.data.has_cps_product=i.data.has_cps_product||0,c&&1==i.data.has_cps_product){
if(r=!0,1==i.cpsfail)return r=!1,!0;
{
l(g);
}
return i.cpsloading=!0,i.cpsfail=!1,new b(i),i.container.find(".appmsg").addClass("selected"),
T.get({
url:"/cgi-bin/cpsproductmaterial?action=get_appmsg_check_status&appmsg_id="+i.data.app_id
},function(t){
return 1==t.cps_check_fail?(i.cpsloading=!1,i.cpsfail=!0,new b(i),i.container.find(".appmsg").addClass("selected"),
void(r=!1)):(i.cpsloading=!1,i.cpsfail=!1,a&&!a()?(_.err("请选择素材"),!0):(e.remove(),
p=null,document.body.style.overflow=document.documentElement.style.overflow="auto",
void(r=!1)));
}),!0;
}
return a&&!a()?(_.err("请选择素材"),!0):(this.remove(),p=null,void(document.body.style.overflow=document.documentElement.style.overflow="auto"));
},
onCancel:function(){
...
_.suc("上传成功"),d.begin=0,s(d);
}
}),n){
if("file"==e&&($(".js_media_list",g).html(u(L,{
list:n
})),$(".frm_radio[type=radio]",g).checkbox(!1),$(".media_content",g).each(function(){
var e=$(this),i=e.data("id"),t=e.data("type"),o=J[i];
o&&t&&F[t]&&F[t](e,o);
})),"appmsg"==e)for(var f=n.length,v=$(".js_appmsg_list .inner",g),w=0;f>w;++w){
var y=n[w],x=v.eq(w%2),k=y.app_id,S=!1;
if(y.multi_item){
for(var C=0;C<y.multi_item.length;C++)(5==y.multi_item[C].share_page_type||7==y.multi_item[C].share_page_type||8==y.multi_item[C].share_page_type)&&(S=!0);
console.log(S);
}
var I=$('<div id="appmsg%s"></div>'.sprintf(k),x).appendTo(x);
new b({
highlight:N.key?!0:!1,
container:I,
data:y,
...
n.each(function(e,i){
var o=A.eq(i%2),n=$('<div id="appmsg%s"></div>'.sprintf(e.app_id),o).appendTo(o);
F[t]&&F[t](n,e);
});
}
...
function o(){
(10==N.type||11==N.type)&&($("#msgSearchInput").on("input",function(){
...
return $("#msgSearchInput").val().length>0?(N.key=$("#msgSearchInput").val(),void d(N)):void _.err("请输入搜索关键词");
...
function s(e){
var o=e.type,l=e.onSelect,d=e.count||10,c=e.begin||0;
return 2==o?void n(e):21==o?void a(e):(t("file","loading",o),void v.getList(o,c,d,function(n){
if(p){
var a={
2:"img_cnt",
3:"voice_cnt",
4:"video_cnt"
},m=n.file_item,r=n.file_cnt[a[o]];
m.length<=0?t("file","no-media",o,m,null,e):(t("file","files",o,m,function(){
...
function d(e){
var o=e.type,n=e.onSelect,s=e.count||10,c=e.key||"",m=e.begin||0;
return N=$.extend(!0,{},e),15==o?void a(e):(t("appmsg","loading",o),void v.appmsg.getList(o,m,s,function(a){
if(p){
var c={
10:"app_msg_cnt",
11:"commondity_msg_cnt",
15:"video_msg_cnt"
},u=a.item,f=a.file_cnt[c[o]];
N.key&&(f=a.search_cnt),u.length<=0?t("appmsg","no-media",o,u,null,e):(t("appmsg","files",o,u,function(){
var e=l(g).parent().data("opt");
return e?(n(o,e),!0):!1;
},e,!0),i(m,s,f,d,e),15==o?(g.on("click",".Js_videomsg",function(){
$(this).find(".loading_tips").length?_.err("视频在转码中，不能选择"):""!=$(this).find(".title").text().trim()&&(g.find(".Js_videomsg").removeClass("selected"),
...
0==r&&("1"==$(this).data("completed")&&"2"==$(this).data("issharemul")||"1"==$(this).data("completed")&&"1"==$(this).data("issharemul")&&"1"==$(this).data("issupportsharemul"))&&(l(g).removeClass("selected"),
$(this).addClass("selected"));
}));
}
},c));
...
return e?(i(t,e),void(o=null)):void _.err("请选择卡券");
},
param:{
need_member_card:1
},
...
allowAudioNumber:1,
selectedAudioItems:P
},function(i){
i&&(i=i[0],P=[i],e.onSelect(3,i));
});
}
e("widget/media/media_dialog.css"),e("widget/media/richvideo.css"),e("common/wx/popup.js");
var r=!1,u=wx.T,p=null,g=null,f=e("common/wx/mpEditor/common/eventbus.js"),h="media align_edge",_=e("common/wx/Tips.js"),v=e("media/media_cgi.js"),w=e("biz_web/utils/upload.js"),y=e("common/wx/pagebar.js"),j=w.uploadBizFile,x=(template.render,
e("common/wx/media/audio.js")),k=e("common/wx/media/img.js"),S=e("common/wx/media/video.js"),b=e("common/wx/media/appmsg.js"),C=e("cardticket/send_card.js"),I=e("common/wx/time.js"),A=I.timeFormat,E=e("tpl/media/dialog/file_layout.html.js"),M=e("tpl/media/dialog/appmsg_layout.html.js"),B=e("tpl/media/dialog/videomsg_layout.html.js"),L=e("tpl/media/dialog/file.html.js"),T=e("common/wx/Cgi.js"),D=1,J={},z={
appmsg:M,
videomsg:B,
file:E
};
...
return e.file_id?(J[e.file_id]=e,""):"";
});
var F={
2:function(e,i){
return new k({
...
s.pubType=1,s.reprintDesc="<div>无法转载，不能转载自己的文章</div>";
break;
...
case"EN_SOURCE_REPRINT_STATUS_REPRINT_WITH_MODIFY":
case"EN_SOURCE_REPRINT_STATUS_REPRINT_WITHOUT_MODIFY":
T="initiative"===_.type?"用户在转载公众号内进行阅读":"将清空对原文的修改，在文章底部展示转载来源";
break;
