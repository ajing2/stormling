...
function r(e,o,r){
var s,i;
r&&"object"==("undefined"==typeof r?"undefined":_typeof(r))?(s=r.done,i=r.fail):s=r,
...
var d=$.ajax(o);
return d.callback=d.done,d.done(function(e){
try{
if(s){
...
if(e&&e.base_resp&&1*e.base_resp.ret!==0&&(o.indexOf("handleRet")<0&&o.indexOf(e.base_resp.ret)<0&&((new Image).src="https://badjs.weixinbridge.com/badjs?level=4&uin={uin}&id={id}&msg={msg}&from={url}".format({
uin:r.uin,
url:r.url||r.location,
id:138,
msg:encodeURIComponent("ret="+r.ret+"|idkey="+r.id+":"+r.key)
})),"undefined"!=typeof window.WX_BJ_REPORT&&window.WX_BJ_REPORT.BadJs)){
var n=this.url;
if(-1!==this.url.indexOf("?")){
n=this.url.substr(0,this.url.indexOf("?"));
var i=new t(this.url);
"String"==typeof i.get("action")&&(n+="?action="+i.get("action"));
}
window.WX_BJ_REPORT.BadJs.report(n,"ret="+e.base_resp.ret,{
mid:window.PAGE_MID,
view:"web_retcode"
});
}
...
i&&i(r),a.error(r,o,e),m.trigger("xhrError",e,r,n,o);
}).always(function(){
o.mask&&n.hide();
}),d;
}
var n=e("common/qq/mask.js"),t=e("common/qq/url.js"),s=e("common/wx/dialog.js"),i=e("common/wx/Tips.js"),a=e("common/wx/cgiReport.js");
e("common/lib/MockJax.js");
var m=e("common/qq/events.js")(!0),c={
dataType:"json",
mask:!1,
timeout:45e3,
error:$.noop,
...
o.show=function(e,o){
var r=d[e.base_resp.ret]||"系统繁忙，请稍后重试("+e.base_resp.ret+")";
return 0==e.base_resp.ret?void(o?s.show({
type:"succ",
msg:"系统提示|"+r
}):i.suc(r)):void(o?s.show("系统繁忙|"+r):i.err(r));
...
var r,n=d[o.ret];
n?o.showMsg&&i.err(n):(r=new Image,r.src="/mp/unknow_ret_report?uin={uin}&id={id}&key={key}&url={url}&location={location}&ret={ret}&method=get&action=report".format(o),
o.showMsg&&i.err(o.msg),(new Image).src="/mp/unknow_ret_report?uin={uin}&id=64430&key=126&url={url}&location={location}&ret={ret}&method=get&action=report".format(o),
