...
e.renderTitle=e.renderTitle||a;
}
e("widget/media.css");
var i=/[\u2600-\u27BF]|[\u2B00-\u2BFF]|[\u3291-\u32B0]|[\uD83C\uD83D][\uDC00-\uDFFF]/,a="未命名图文",r=(wx.T,
e("common/wx/time.js")),l=e("media/appmsg_temp_url.js"),m=e("tpl/media/appmsg.html.js"),s=e("common/qq/Class.js"),d=s.declare({
init:function(e){
if(e&&e.container){
if(e.data=e.data||$.extend({},e),e.data.multi_item)for(var a=0;a<e.data.multi_item.length;a++){
var s=e.data.multi_item[a];
if(1==s.smart_product){
e.data.smart_product=1;
break;
}
}
var d=e.data,o=d.multi_item||[],p=o.length,c=null,n=!0,_="",u=[];
if(!(0>=p)){
c=o[0],c.completed=!0,(!c.title||!c.cover&&7!=c.share_page_type)&&(n=!1,c.completed=!1),
i.test(c.title)&&(_="title-emoji",n=!1,c.completed=!1),c.cover&&(c.cover=c.cover.nogif());
for(var a=1;p>a;++a){
var s=o[a];
s.completed=!0,u.push(s),s.title&&s.cover||7==s.share_page_type||(n=!1,s.completed=!1),
i.test(s.title)&&(_="title-emoji",n=!1,c.completed=!1),s.cover&&(s.cover=s.cover.nogif());
}
e.cpsfail&&1==e.cpsfail&&(n=!1);
var g=e.highlight===!0;
t(c,g),u.forEach(function(e){
t(e);
});
var h={
highlight:g,
...
type:e.type,
file_id:d.file_id,
time:d.create_time?r.timeFormat(d.create_time):"",
update_time:d.update_time?r.timeFormat(d.update_time):"",
isMul:p>1,
first:c,
list:u,
completed:n,
notCompletedType:_,
is_illegal:1*d.is_illegal||0,
token:wx.data.t,
...
},f=$(e.container).html(wx.T(m,h));
if(e.highlight===!0){
for(var s=$.extend({},e),a=0,v=s.data.multi_item.length;v>a;a++){
var j=s.data.multi_item[a];
j.title=j.title.replace(/<em>/g,"").replace(/<\/em>/g,"");
}
f.data("opt",s);
}else f.data("opt",e);
this.renderData=h,l(e.container,".js_title a,.js_preview");
}
}
},
getData:function(){
