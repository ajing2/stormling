...
status:r,
disabledTips:s
}),t.fireEvent("setCommentStatus",!0),t.fireEvent("setOriginalStatus",{
status:!0,
type:"reprint"
...
"use strict";
var e=i("tpl/media/appmsg_edit/image_article_content_9.html.js"),t=i("media/base_article.js"),a=(i("biz_common/jquery.validate.js"),
i("common/wx/mpEditor/common/eventbus.js")),n=i("common/wx/media/img9.js"),r=t.inherit({
init:function(){
this.initTextEditorEnv();
},
initData:function(){
var i=this,e=t.prototype.initData.call(this);
return e.set("share_page_type",8),e.get("share_imageinfo")||e.set("share_imageinfo",[]),
this.setTitle(e),this.setShareImageid(e),e.set("author",""),e.set("file_id",""),
setTimeout(function(){
i.getImageWh();
},0),e;
},
...
setTitle:function(i){
var e=i.get("guide_words")||"";
i.set("title",e||"分享图片");
},
setShareImageid:function(i){
for(var e=i.get("share_imageinfo")||[],t=[],a=0;a<e.length;a++)t.push(e[a].file_id);
i.set("share_imageid",t.join(","));
},
getImageWh:function(){
var i=this.data.get("share_imageinfo");
if(i&&0!=i.length)for(var e=0;e<i.length;e++){
var t=i[e];
!t.cdn_url||t.height&&t.width||!function(i,e,t){
var a=new window.Image;
a.onload=function(){
var e=this.naturalWidth||this.width||0,t=this.naturalHeight||this.height||0;
i.setImageWh(this.src,e,t);
},a.src=t;
}(this,e,t.cdn_url);
}
},
setImageWh:function(i,e,t){
if(i&&e&&t){
var a=this.data.get("share_imageinfo");
if(a&&a.length>0){
for(var n=0;n<a.length;n++){
var r=a[n];
r.cdn_url===i&&(r.width=e,r.height=t);
}
...
$dom:this._o.$infoContainer,
strict:!1
},t=JSON.parse(i.share_imageinfo);
if(t&&t.list&&t.list.length>0)e=this.validateGuideWords(e);else{
var a=this._o.$infoContainer;
this.showErrMsg(a.find(".js_content_error"),"请先上传图片，再点击保存按钮。"),e.viewClass=".js_content_error",
e.isValid=!1;
}
return this.handleValidateResult(e);
},
...
i;
}),a.container="#reprint_article_main",a.isappend=!1,new n(a,function(e){
e.map(function(i){
return i.cdn_url=i.url,i;
}),i.data.set("share_imageinfo",e),i.coverChange(e&&e.length>0?{
url:e[0].cdn_url,
file_id:"",
oriUrl:e[0].cdn_url,
oriFormat:"",
...
}),e.fireEvent("renderEditorByType",2),e.fireEvent("setTitleStatus",{
display:"none"
}),setTimeout(function(){
i.getImageWh();
},0);
...
if(!e)return void i.onCancel();
var t=[];
if(e&&e.length>0)for(var a=0;a<e.length;a++)t.push({
file_id:e[a].fileId,
cdn_url:e[a].url,
width:"",
height:""
...
return r.hideDialog=function(i){
o.fireEvent("hideAudioMusicDialog",i);
},r.showDialog=function(i){
...
return s.rangelength(i.item.content.replace(/<.*?>/g,""),[0,300])||(this.showErrMsg(i.$dom.find(".js_content_error"),"文本长度不能超过%s字".replace("%s",300)),
...
"use strict";
var e=i("common/wx/media/videoUtils.js"),t=i("common/wx/mpEditor/common/eventbus.js"),o=i("tpl/media/appmsg_edit/video_article_content.html.js"),d=i("media/base_article.js"),s=i("biz_common/jquery.validate.js"),r=i("biz_web/lib/store.js"),a=i("common/wx/const.js"),n=i("media/common.js"),_=(s.rules,
300),l=d.inherit({
init:function(){
this.initTextEditorEnv();
},
...
var e=i.isMyMpVideo||i.is_my_mp_video?a.videoDigestPlaceholder:"从这里开始输入推荐语，可以不填";
this._o.ueditor.fireEvent("switchContentType",{
placeholder:e,
type:2
});
...
var i=a.hasShowVideoModifyDialogKey+location.pathname;
r.get(i)||!this.data.get("isMyMpVideo")&&!this.data.get("is_my_mp_video")||(this._o.ueditor.fireEvent("showVideoModifyDialog"),
r.set(i,1));
},
...
e||(this.showToolbar(),this.enableToolbar()),this.setTextEditorWordlimit(_),this._hasRendered=!0;
},
destroy:function(){
...
d.prototype.updateTitleInputCounter.call(this,a.videoTitleMaxLen);
}
});
return l.hideDialog=function(i){
t.fireEvent("hideVideoDialog",i);
},l.showDialog=function(i){
