...
e("biz_common/jquery.validate.js")),s=e("common/wx/Tips.js"),n=e("common/wx/Cgi.js"),o=e("common/wx/mpEditor/plugin/remoteimg.js"),d=a.rules,_=e("common/wx/mpEditor/common/base_class.js"),c=e("media/article_data_key.js"),l=e("common/wx/mpEditor/text_editor.js"),h=e("tpl/media/appmsg_edit/article_list_item.html.js"),u=e("media/get_article_structure.js"),f=u.getArticleStructure,p=u.getArticleStructureNoAd,m=e("common/wx/const.js"),g=(m.moreReadModeMap,
m.DEFAULT_AD_TEXT),v=m.NO_AD_TEXT,w=m.videoPasterMinPlayLength,y=e("common/wx/utils.js"),j=y.formatVideoTime,b=["一","二","三","四","五","六","七","八","九","十"],C={
...
onChange:function(t){
if("10"==e.data.get("share_page_type")){
var i=e._o.ueditor.fireEvent("get_current_article");
i&&i.find(".js_appmsg_txt").html(t.replace(/<\/?a[^>]*?>/gi,""));
}
},
onBlur:function(){
...
initData:function(){
var e=this._o.data,t=this._o.index,r=this._o.cgiData,a=c.getLocalKey(t);
...
a.only_fans_days_can_comment=n.only_fans_days_can_comment);
}
}else a.need_open_comment=0;
if(0==a.need_open_comment&&(a.only_fans_can_comment=0,a.only_fans_days_can_comment=0),
a.title_tips="第%s篇图文".sprintf(b[t]),a.cdn_url_back||(a.cdn_url_back=a.cdn_url),a.cdn_url?(a.cover=a.cdn_url=a.cdn_url.nogif(),
...
var t=this._o.$articleList,i=t.children(),r=i.length||0,a=this.data.getData(),s=$.parseHTML(wx.T(h,a))[0],n=null;
...
this.data.set("isFirst",0==e),this.data.set("title_tips","第%s篇图文".sprintf(b[e])),
...
var e=this,t=e.data.getData(),i=e._o.$infoContainer,r=$("#js_album_area"),a=0===t.share_page_type||10===t.share_page_type;
window.wx.cgiData.can_use_album&&a?n.get({
url:"/cgi-bin/appmsgalbummgr?action=list",
data:{
begin:0,
count:10,
type:0
...
var s=a.list_resp&&a.list_resp.items;
1*a.base_resp.ret===0&&s&&s.length>0?r&&r.length>0&&(e.data.set("appmsg_album",t.appmsg_album_info.id||""),
i.find(".js_album").checkbox("checked",!!t.appmsg_album_info.id),t.appmsg_album_info.id?(r.find(".album_setting").html(t.appmsg_album_info.title||"").show(),
r.find(".js_album_allow_click").addClass("open")):(r.find(".album_setting").hide(),
r.find(".js_album_allow_click").removeClass("open"))):r&&r.hide();
}):r&&r.hide();
},
renderAd:function(){
var e=this,t=e.data.getData(),i=e._o.$infoContainer;
...
}),r.find(".js_can_reward").html(t.can_reward?"已开启":"未开启"),r.find(".js_author").html(t.author),
r.find(".js_amount").html("￥"+t.pay_fee/100),""!==t.pay_desc?(r.find(".js_desc_wrap").show(),
r.find(".js_desc").html(t.pay_desc)):r.find(".js_desc_wrap").hide(),r[0].style.display="",
$("#js_original").hide();
...
(0===n.length||n.length&&"none"===n[0].style.display)&&s.hide(),this.data.set("insert_ad_mode",""),
...
traversePayDomList:function(e,t){
var i=0;
e.some(function(e,r){
return e.isWrapper?void 0:"function"==typeof t?(i++,1===i&&(e.topMargin=0),t(e,r)):!0;
});
},
setPayPopup:function(e){
var t=this,i=this.data,r=this._o.$infoContainer,a=r.find("#js_pay_preview_popup"),n=r.find("#js_pay_preview_popup_temp"),o=r.find("#js_pay_set_education"),d=r.find("#js_pay_preview_popup_mask"),_=e.mode,c=p(this.editor.ueditor.body,{
getNestedStructure:!0,
ignoreFlexChildren:!0,
ignoreNotWriteableChildren:!0,
needEl:"init"===e.mode,
getSpan:!0
}),l=0,h=0,u=0,f=0,m=!0,g=0,v=0;
if(c.length&&(this.traversePayDomList(c,function(e,t){
var i=e.topMargin;
i>g&&(g=i,v=t);
}),g+=c[v].height+c[v].marginBottom),"init"===_)m=!1,this.traversePayDomList(c,function(e){
...
var i=g*e.previewPercent/100;
t.traversePayDomList(c,function(e){
var t=e.topMargin;
return u++,h=l,l=t,l>=i?(l>i&&(l=h,u--),!0):void 0;
});
}();else if("up"===_||"down"===_){
if(f=1*parseFloat(a.css("top")).toFixed(2),"up"===_&&0===f)return;
this.traversePayDomList(c,function(e){
var t=e.topMargin;
return u++,h=l,l=t,l>=f&&"up"===_?(l=h,u--,!0):l>f&&"down"===_?!0:void 0;
});
}else!function(){
var e=1*a.data("offset"),i=1*n.data("offset"),r=0,s=!1,o=!1;
t.traversePayDomList(c,function(t){
var a=t.topMargin;
return s&&o?!0:(s||(u++,l=a,u===e&&(s=!0)),void(o||(r++,r===i&&(o=!0,n.css({
marginTop:j+"px",
top:a+"px"
})))));
});
...
if(m){
var w="init"!==_?0===g?0:Math.ceil(l/g*100):1*i.get("pay_preview_percent");
100===w&&(w=99);
var y=this._o.ueditor.ueditor.iframe.parentNode,j=parseInt(getComputedStyle(y).paddingTop);
a[0].parentNode!==y&&(y.insertAdjacentElement("afterbegin",d[0]),y.insertAdjacentElement("afterbegin",a[0]),
y.insertAdjacentElement("afterbegin",o[0])),a.css({
marginTop:j+"px",
top:l+"px"
}),d.css({
marginTop:j+"px",
height:l+"px"
}),"up"===_||"down"===_?(document.documentElement.scrollTop=document.documentElement.scrollTop+l-f,
document.body.scrollTop=document.body.scrollTop+l-f):"set"===_&&(document.documentElement.scrollTop=l,
document.body.scrollTop=l,!e.isFromDialog&&e.previewPercent!==w&&s.err("由于文章以段落划分免费试读区域，输入值无法生效，已自动为你切换到最近的有效数值")),
a.data("offset",u),a.find(".js_preview_percent").html(w+"%"),r.find("#js_pay_setting_preview .js_preview_percent").html(w+"%"),
"init"!==_&&i.set("pay_preview_percent",w);
}
},
setTempPayPopup:function(e){
var t=this,i=this._o.$infoContainer,r=i.find("#js_pay_preview_popup_temp"),a=0,s=0;
if("hide"===e.mode)return void r.removeData("offset").hide();
if("top"===e.mode)a=0,s=1;else if("dom"===e.mode){
var n=function(){
var i=p(t.editor.ueditor.body,{
getNestedStructure:!0,
ignoreFlexChildren:!0,
ignoreNotWriteableChildren:!0,
needEl:!0,
...
return t.traversePayDomList(i,function(t){
var i=t.el,n=t.topMargin;
return s++,r?(a=n,!0):void(i.contains(e.dom)&&(r=!0));
}),r?void 0:{
v:void 0
};
}();
...
var o=p(this.editor.ueditor.body,{
getNestedStructure:!0,
ignoreFlexChildren:!0,
ignoreNotWriteableChildren:!0,
needEl:!0,
...
if(this.traversePayDomList(o,function(t){
var i=t.topMargin;
return s++,i>=e.y?(a=i,!0):void 0;
...
r[0].parentNode!==d&&d.insertAdjacentElement("afterbegin",r[0]),1*i.find("#js_pay_preview_popup").data("offset")!==s?r.css({
marginTop:_+"px",
top:a+"px"
}).data("offset",s).show():r.removeData("offset").hide();
},
...
e.find(".js_title_error,.js_author_error,.js_desc_error,.js_tip_mask_msg,.js_cover_error,.js_url_error,.js_catch_tips,.js_content_error,.js_platform_error,.js_ad_error_tips").hide(),
e.find(".js_tip_mask").removeClass("error_mask");
},
flushGuidWords:function(){
var e=l.getEditor(this._o.ueditor,this._o.formItemsOpt),t=e.getContent();
...
}),0==e.get("need_open_comment")?(e.set("only_fans_can_comment",0),e.set("only_fans_days_can_comment",0)):(e.set("only_fans_can_comment",1*$(".js_comment_setting:checked").val()===1?1:0),
e.set("only_fans_days_can_comment",1*$(".js_comment_setting:checked").val()===2?1:0)),
...
var i=this,r=i.data.getData(),a={},s=C.submitKey;
this.isCurrentArticle()&&(this.data.getData().sections=f(this.editor.ueditor.body),
r.compose_info=JSON.stringify(0===r.share_page_type?{
list:p(this.editor.ueditor.body)
}:{
list:""
}),10===r.share_page_type&&(r.count=1,r.content=r.guide_words,r.guide_words="",r.title="")),
$.each(s,function(e,t){
switch(t){
case"fileid":
a[t]=r.file_id;
...
return this.checkSourceUrl(e),d.rangelength(i.digest,[0,this._g.maxDigest])||(t.find(".js_desc_error").text("摘要长度不能超过%s字".sprintf(this._g.maxDigest)).show(),
...
d.rangelength(i.digest,[0,this._g.maxDigest])||(t.find(".js_desc_error").text("摘要长度不能超过%s字".sprintf(this._g.maxDigest)).show(),
...
t&&(this.showErrMsg(e.$dom.find(".js_content_error"),t),e.viewClass=e.viewClass||".js_content_error",
e.isValid=!1);
},
...
e.viewClass=e.viewClass||".js_url",e.isValid=!1),i.sourceurl&&!d.url(i.sourceurl)&&(t.find(".js_url_error").text("链接不合法").show(),
...
if(!d.rangelength(e.item.guide_words,[0,this._o.guideWordlimit])){
var t=this.getArticleType()===x?"简介":"推荐语",i="%n长度不能超过%s字".replace("%n",t).replace("%s",this._o.guideWordlimit);
this.showErrMsg(e.$dom.find(".js_content_error"),i),e.viewClass=e.viewClass||".js_content_error",
e.isValid=!1;
}
return e;
},
...
a=t.is_new_create?i||t.advert_info&&t.advert_info.back_transition&&t.advert_info.back_transition.ad_video_transition||r||g:i||t.advert_info&&t.advert_info.back_transition&&t.advert_info.back_transition.ad_video_transition,
e.find(".ad_transition_area").show(),a&&a!==v?(e.find(".js_ad_back").checkbox("checked",!0),
...
1==Number(t.only_fans_can_comment)&&1==e?$(this).checkbox("checked",!0):1==Number(t.only_fans_days_can_comment)&&2==e?$(this).checkbox("checked",!0):0==Number(t.only_fans_can_comment)&&0==Number(t.only_fans_days_can_comment)&&0==e?$(this).checkbox("checked",!0):$(this).checkbox("checked",!1);
...
if(e.share_page_type===x&&wx.cgiData.canUseVideoPaster)if(t.show(),e.share_videoinfo[0].play_length>=w&&(e.isMyMpVideo||e.is_my_mp_video))if(t.removeClass("video-disabled"),
...
this.renderAd(),this.renderAlbum(),this.triggerInputValidate(),this.updateTitleInputCounter(64);
},
...
t.html("")),$("#js_pay_preview_popup").hide(),this.hidePayEducation();
...
var r=l.getEditor(this._o.ueditor,this._o.formItemsOpt);
