...
this.redbit=t.redbit||1,this.notHideMenu=!1;
};
...
var e=this;
if(t.$imgMenu=$(".js_img_dropdown_menu"),t.$uploadFile=t.$imgMenu.children().find("input[type=file]"),
!t._hasMenuShow){
t._showMenu(e);
var i="imgExpansionTips_"+wx.commonData.data.uin,a=localStorage.getItem(i);
"1"!==a&&(localStorage.setItem(i,"1"),t.notHideMenu=!0,$("#tpl_image_expansion_tips").popup({
title:"通知",
buttons:[{
text:"我知道了",
type:"primary",
