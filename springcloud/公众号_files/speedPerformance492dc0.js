...
n=n?n+":#:"+l:l,r=r?r+":#:"+p:p,a=a?a+":#:"+w:w,i=i?i+":#:"+c:c,o.push(d);
}
var m=d.childNodes;
m=Array.prototype.slice.call(m,0).reverse();
for(var g=0;g<m.length;g++)t.push(m[g]);
}
return{
wholeText:n,
wholeTextColor:r,
...
function n(e){
for(var t,o,n=9,r=n,a=s.getHtmlText(e),i=0;i<w.length;i++)if(t=w[i].exec(e.outerHTML)){
r=i+1,o=t[t.length-1]||"";
break;
}
if(r!==n&&a.length&&(r=0),r===n&&"center"===getComputedStyle(e).textAlign){
var d=a.length,l=a.match(/[\u4e00-\u9fa5]+/g);
l&&l.length&&(d+=l.join("").length),50>=d&&(r=11);
}
return{
textContent:a,
sectionType:r,
...
function a(e){
for(var t=Date.now(),o=Math.random()<.2,a=document.createElement("p"),i=r(e,a),d=l(e,{
isMarkNode:function(e){
return u.isMarkNode(e);
},
getNestedStructure:!0
}),s=[],w=d.length,m=0,g=Date.now(),x=0;w>x;x++){
var f=d[x],h=l.paragraphStartIdx+x;
if(f.sectionIdx=h,f.isWrapper){
for(var v=[],_=0;_<f.children.length;_++)f.children[_].sectionIdx&&v.push(f.children[_].sectionIdx);
s.push({
section_index:h,
embedment:v
});
...
var b=n(f);
m+=b.textContent.length,s.push({
section_index:h,
text_content:b.textContent,
section_type:b.sectionType,
extra_content:b.extraContent
});
}
}
o&&(c.saveSpeeds({
...
for(var y=Date.now(),C=0;w>C;C++){
var S,j=d[C].parentNode,k=s[C],T=k.text_content?k.text_content.length:0,A=(s[C-1]?s[C-1].textCountBefore:0)+T;
k.textCountBefore=A,S=j===e?i:r(j,a);
var N=i?S/i:0;
.7>=N?k.ad_available=!1:p>A||p>m-A||j.style.height&&j!==e||j.style.maxHeight?k.ad_available=!1:(s.autoAdAvailable=!0,
k.ad_available=!0,k.width_rate=N);
}
o&&(c.saveSpeeds({
uin:window.wx&&window.wx.data&&window.wx.data.uin||0,
pid:34,
...
for(var B=Date.now(),z=0;w>z;z++){
var D=s[z];
if(D.ad_available){
for(var M=z+1;w>M;M++)if(s[M].ad_available&&s[M].textCountBefore-D.textCountBefore>=p){
D.second_ad_available=s[M].section_index,s.secondAutoAdAvailable=!0;
break;
}
delete D.textCountBefore;
}else delete D.textCountBefore;
}
return o&&(c.saveSpeeds({
uin:window.wx&&window.wx.data&&window.wx.data.uin||0,
pid:34,
speeds:[{
sid:40,
...
function i(e){
for(var t=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],r=l(e,{
isMarkNode:function(e){
return u.isMarkNode(e);
},
...
getSpan:t.getSpan
}),a=[],i=r.length,d=function(){
var e=r[s];
c=n(e),p=o(e);
var i=e.style.overflowY;
e.style.overflowY="hidden";
var d=e.offsetTop;
void 0===d&&(d=0,Array.prototype.forEach.call(e.getClientRects(),function(e){
d<e.bottom&&(d=e.bottom);
})),d=1*d.toFixed(2);
var l={
blockIdx:s+1,
content:e.outerHTML,
...
t.needEl&&(l.el=e),a.push(l),e.style.overflowY=i||"",e.style.cssText||e.removeAttribute("style");
},s=0;i>s;s++){
var c,p;
d();
}
...
var d=e("common/wx/const.js"),l=e("biz_common/utils/get_para_list.js"),s=e("utils/common.js"),u=e("3rd/editor/common/domUtils.js").domUtils,c=e("biz_common/utils/wxgspeedsdk.js"),p=d.textCountAroundAd,w=[t("img","","src"),t("iframe","wx_video_iframe","src"),t("iframe","js_editor_audio","src"),t("iframe","js_editor_vote_card","src"),t("iframe","js_editor_card","src"),t("iframe","js_editor_cpcad","src"),t("iframe","weapp_app_iframe","data-miniprogram-appid"),t("iframe","js_editor_cps","src"),t("blockquote","","data-url")];
return{
