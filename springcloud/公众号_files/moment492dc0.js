...
"use strict";
function t(){
if("-1"==N.navigatorType)return"";
if(!N.navigatorType){
var e=window.navigator.userAgent;
N.navigatorType=/360se/i.test(e)?"360":/metasr/i.test(e)?"搜狗":/LBBROWSER/i.test(e)?"猎豹":/QQBrowser/i.test(e)?"QQ":/Edge/i.test(e)?"Edge":/Opera/i.test(e)||/Opr\//i.test(e)?"Opera":/chrome/i.test(e)?"Chrome":/Safari/i.test(e)?"Safari":/Firefox/i.test(e)?"Firefox":/MSIE/i.test(e)||/Trident\//i.test(e)?"IE":"-1";
}
return N.navigatorType;
}
function i(e){
...
function r(e,t,i){
(t||1)>C&&$.post("/misc/jslog?1=1"+wx.data.param,{
id:e,
level:i||"error",
content:"[file=media/appmsg_edit]"
});
}
var a=e("common/wx/media/previewDialog.js"),n=e("media/common.js"),o=e("common/wx/media/keywordDialog.js"),s=e("common/qq/events.js")(!0),c=e("common/wx/mpEditor/common/base_class.js"),l=e("common/wx/time.js"),_=e("biz_web/lib/store.js"),p=e("common/wx/Tips.js"),u=e("common/wx/dialog.js"),f=e("common/wx/popover.js"),m=e("common/wx/mpEditor/plugin/remoteimg.js"),h=e("biz_common/moment.js"),g=e("common/wx/const.js").insertAdModeMap,v=e("common/wx/Cgi.js"),w=e("common/wx/speedPerformance.js"),x=e("media/media_cgi.js"),y=e("media/article_interface.js"),b=e("media/draft.js"),j=e("media/report.js"),A=e("media/appmsg_dialog.js"),D=e("media/get_article_structure.js"),k=D.getArticleStructure,E=D.getArticleStructureNoAd,T=["一","二","三","四","五","六","七","八","九","十"],N={
...
},C=Math.random(),S=n.eq,I=c.inherit({
init:function(e){
var t=this;
...
var e=null;
return 2==wx.cgiData.material_type&&wx.cgiData.material_id?(e=wx.cgiData.app_msg_info.material_info.share_imageinfo[0],
{
cdn_url:e.cdn_ur,
share_imageinfo:[{
file_id:e.file_id,
...
share_page_type:8
}):3==wx.cgiData.material_type&&wx.cgiData.material_id?(e=wx.cgiData.app_msg_info.material_info.share_voiceinfo[0],
{
share_voice_id:e.file_id,
share_voiceinfo:[{
file_id:e.file_id,
duration:h.unix(e.play_length/1e3).format("mm:ss"),
title:e.title,
play_length:e.play_length/1e3,
play_url:e.play_url
}],
title:e.title,
share_page_type:7
}):15==wx.cgiData.material_type&&wx.cgiData.material_id?(e=wx.cgiData.app_msg_info.material_info,
{
share_video_id:e.content,
share_videoinfo:[{
...
video_id:e.content,
duration:e.duration,
play_length:this._durationStr2Sec(e.duration)
}],
cdn_url:e.cover,
title:e.title,
isMyMpVideo:1==e.is_mp_video,
share_page_type:5,
...
return wx.cgiData.material_type&&wx.cgiData.material_id;
},
...
u.show({
type:"warn",
msg:"文字消息模块还在调试中，若需群发文字消息，请使用订阅号助手APP。",
buttons:[{
text:"关闭",
click:function(){
window.close();
...
e.hasConfirmed=!1,N.$actionBtn=$(template.render("tpl_article_action",{})).appendTo("body"),
...
if(S(this.lastData,this.draft.data))return void e.draft.clear();
...
if(N.debug||50==Math.floor(100*Math.random())||(","+N.draftTipsreportList.join(",")+",").indexOf(","+r+",")>=0){
...
if(e._saving!==!0&&e.crop_img_ing!==!0&&r===!0&&a===!0&&!S(i||!1,e.getData()||!1)){
...
1&a.right&&(N.$actionBtn=null,r.ueditor.fireEvent("renderReadOnly",{
right:a.right,
type:a.index,
time:e||"",
name:t||"",
...
var e=this.$list.children().eq(N.articleSelectIdx),t=e.data("article"),i=t.getListItem(),r=i.offset(),a=r.top;
N.$actionBtn.css({
top:a+i.height()/2-N.$actionBtn.height()/2,
left:r.left+i.width()
});
},
...
var e=this.$list.children().eq(N.articleSelectIdx),t=$(".js_replace_appmsg"),i=$(".js_down"),r=$(".js_up"),a=$(".js_del");
...
var t=this;
if(N.$actionBtn){
var i=$(".js_article_panel"),r=!N.$actionBtn.is(":hidden"),a=i[0]&&!i.is(":hidden");
a&&!r&&(i.hide(),a=!1);
var n=$(e.target).closest(".js_appmsg_item"),o=n.index();
o===N.articleSelectIdx&&(t._updateActionBtn(),N.$actionBtn.show());
}
},
_hideActionBtn:function(){
var e=N.$actionBtn,t=$(".js_article_panel");
if(e){
...
var t=N.$actionBtn,i=$(".js_article_panel"),r=e.target;
...
e._g.delPopover&&(e._g.delPopover.resetPosition($(".js_del")),e._g.delPopover.$dom=N.$actionBtn);
}
};
},
_bindEvent:function(){
...
return N.isArticleRemoving=void 0===t?N.isArticleRemoving:!!t,N.isArticleRemoving;
...
$(e).hasClass("js_replace_appmsg")||$(e).hasClass("js_del")?N.actionClicked=a||n||o?!0:!1:($(".js_article_panel").hide(),
N.actionClicked=!1,a||n||$(".js_appmsg_action").find(".js_action_btn").removeClass("current")),
$(e).addClass("current"),N.actionBtnToolTipsId&&(clearTimeout(N.actionBtnToolTipsId),
N.actionBtnToolTipsId=null),N.actionBtnToolTipsId=setTimeout(function(){
...
N.actionClicked=!0):(e._hideActionBtn(),e._g.delPopover&&e._g.delPopover.hide());
}),$(".js_appmsg_action").on("mouseleave",".js_action_btn",function(){
N.actionClicked||$(this).removeClass("current"),N.actionBtnToolTipsId&&(clearTimeout(N.actionBtnToolTipsId),
N.actionBtnToolTipsId=null),$(this).find(".js_tooltips").hide();
...
var t=e.$list.children().eq(N.articleSelectIdx),i=t.prev();
t.insertBefore(i),e._updateTitleTips(),N.articleSelectIdx--;
}
}),$(".js_appmsg_action").on("click",".js_down",function(){
if(e._saving!==!0){
e.ueditor.fireEvent("reportAddNum",121548,13,1);
var t=e.$list.children().eq(N.articleSelectIdx),i=t.next();
i.insertBefore(t),e._updateTitleTips(),N.articleSelectIdx++;
}
...
if(S(a,e.lastData))return void(e.draft&&e.draft.clear());
t.preventDefault();
...
e._hasAppmsgType()&&window.localStorage&&localStorage.removeItem(N.CACHE_TYPE_KEY),
...
N.$actionBtn&&!N.$actionBtn.is(":hidden")&&e._updateActionBtn(),e.ueditor.fireEvent("update_action_panel_pos"),
...
text:"确定",
click:function(){
if(i.ueditor.fireEvent("reportAddNum",121548,24,1),i.drop(N.articleSelectIdx),i.renderCreateBtn(),
i.app_id){
var e=new Image;
e.src="/cgi-bin/reportmaterialoper?oper=1&idx="+N.articleSelectIdx+"&msgid="+i.app_id+"&token="+wx.data.t;
}
...
onShow:function(){
var e=i.$list.children().eq(N.articleSelectIdx),t=e.data("article").data.getData(),r=this.$pop.find("#js_del_title").eq(0),a=8===t.share_page_type?t.guide_words||"":t.title;
r.html(t&&a?"："+a+"？":"？"),this.resetPosition($(".js_del")),this.$dom=N.$actionBtn,
...
o.addClass("current");
var s=null;
if(o.siblings().removeClass("current"),N.articleSelectIdx=t,n.$current){
...
list:E(this.editor.ueditor.body)
...
if(N.articleScrollId&&(clearTimeout(N.articleScrollId),N.articleScrollId=null),r||(N.articleScrollId=setTimeout(function(){
...
var d=s.data.getData(),u=d.insert_ad_mode?d.insert_ad_mode:a?wx.cgiData.insert_ad_mode:g.none,f=-1!==d.content.indexOf("js_cpc_area"),m=-1!==d.content.indexOf("appmsg_edit_ad_preview"),h=f||m?g.op:u;
n.ueditor.fireEvent("setArticleAdMode",h),n.ueditor.fireEvent("setArticleAdCategoriesList",d.categories_list),
setTimeout(function(){
...
S(n,o,null,null,!0)&&((new Image).src="//mp.weixin.qq.com/mp/jsmonitor?idkey=%s_%s_1&lc=1&log0=[repeat][appid:%s,idx:%s,bizuin:%s]".sprintf(28308,1,t.app_id||0,r,wx.data.uin));
}
});
}catch(s){}
},
...
"content"==r&&10==t.share_page_type&&(i[r]=a);
}),$.extend(a,i);
}),a;
},
...
for(var g=[],v=0,w=d.cover_uri_info_list.list.length;w>v;v++){
var x=d.cover_uri_info_list.list[v];
1*x.status>0&&g.push(x);
}
0===g.length?p.err(t):f.editor.fireEvent("showRedPackageCoverDialog",{
errorData:g
});
}else p.err(t);
break;
...
f._saving=!1,e.btn(!0),p.err("保存失败，请稍后再试"),_&&((new Image).src="//mp.weixin.qq.com/mp/jsmonitor?idkey=%s_%s_1&lc=1&log0=editor_save_error;errmsg:%s,appid:%s,bizuin:%s".sprintf(28308,_,h.message,f.app_id||0,wx.data.uin)),
window.BJ_REPORT&&"function"==typeof window.BJ_REPORT.report&&h&&h.stack&&(h.stack="editor_save_error|"+h.stack,
window.BJ_REPORT.report(h)),h.stack&&console&&console.error&&console.error("[BJ-REPORT]",h.stack);
}
}
},
...
return function(){
var n=t.editor;
n&&e.fireEvent("showTemplateDialog",{},function(t){
