...
class Solution {
    public List<String> topKFrequent(String[] words, int k) {
        PriorityQueue minHeap = new PriorityQueue<Map.Entry<String, Integer>>(new Comparator<Map.Entry<String, Integer>>() {
            @Override
        ...
        while (!minHeap.isEmpty()) {
            res.add(0, ((Map.Entry<String, Integer>)minHeap.poll()).getKey());
        }
        return res;
    }
}
